...
<!--/////////////////////EMPIEZA CUERPO INTERNO DEL PROYECTO//////////////// -->
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Pagina Principal <small>Inicio</small></h1>
            </div>
        </div>
        <section class="full-reset text-center" style="padding: 40px 0;">
            ...
            <article class="tile">
                ...
                <div class="tile-name all-tittles">Demeritos</div>
                <div class="tile-num full-reset">37</div>
            </article>
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-book"></i></div>
                <div class="tile-name all-tittles">PDF</div>
