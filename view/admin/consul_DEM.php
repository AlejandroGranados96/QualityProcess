...
<?php 
foreach ($cons_DEMERITOS as $cols) {
    ?>
    <tr>
                    
                    <td><?php echo $cols['id_demerito']?></td>
                    <td><?php echo $cols['mes']?></td>
                    <td><?php echo $cols['fecha']?></td>
                    <td><?php echo $cols['No_carroceria']?></td>
                    <td><?php echo $cols['modelo']?></td>
                    <td><?php echo $cols['segmento']?></td>
					<td><?php echo $cols['no_conformidad']?></td>
					<td><?php echo $cols['componente']?></td>
					<td><?php echo $cols['complemento']?></td>
                    <td>
                    
                        <a href="mod_DEM?nik=<?php echo $cols['id_demerito']?>" title="Editar datos" class="btn btn-info btn-sm">Editar Datos</a>
                        <a href="borar_DEM?id=<?php echo $cols['id_demerito']?>"  onclick="return confirm('¿Esta seguro de borrar el registro?');" class="btn btn-danger btn-sm">Eliminar</a>
                    </td>
                    <?php }	?>
    </table>
