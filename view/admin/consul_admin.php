...
<head>
  ...
  <title>Consulta Usuarios | Administrador</title>
...
<?php 
foreach ($cons_usuarios as $cols) {
    ?>
    <tr>
                    
                    <td><?php echo $cols['id_usuario']?></td>
                    <td><?php echo $cols['nombre']?></td>
                    <td><?php echo $cols['apellido']?></td>
                    <td><?php echo $cols['numero_empleado']?></td>
                    <td><?php echo $cols['email']?></td>
                    <td type="password" class="hidetext"><?php echo $cols['contrasena']?></td>
                    <td><?php echo $cols['rol']?></td>
                    <td>
                    
                        <a href="mod_usuario?nik=<?php echo $cols['id_usuario']?>" title="Editar datos" class="btn btn-info btn-sm">Editar Datos</a>
                        <a href="borrar?id=<?php echo $cols['id_usuario']?>"  onclick="return confirm('¿Esta seguro de borrar el registro?');" class="btn btn-danger btn-sm">Eliminar</a>
                    </td>
                    <?php }	?>
    </table>
