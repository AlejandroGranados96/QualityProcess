...
$id_col = $_GET['nik'];
$col=new consul();
$cons_usuarios=$col->usuario_cons($id_col);
?>
<!DOCTYPE html>
<html lang="en">
...
<header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="inicioAdmin" class="logo">Consulta <span class="lite">Usuarios</span></a>
      <!--logo end-->
            ...
            <div id="iniciar-sesion">
               ...
               <form action="add_info" method="post">
                    ...
                    <div class="contenedor-input">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row ['apellido']; ?>" name="apellido"  placeholder="Apellido" required/>
                    </div>
                    ...
                    <div class="contenedor-input">
                        ...
                        <input type="number" class="form-control" value="<?php echo $row ['numero_empleado']; ?>" name="numempleado" placeholder="Numero_Empleado" required/>
                    </div>
                    ...
                    <div class="contenedor-input">
                        ...
                        <input type="email" class="form-control" value="<?php echo $row ['email']; ?>" name="email" placeholder="correo" required/>
                    </div>
                    ...
                    <div class="contenedor-input">
                        ...
                        <input type="password" class="form-control" value="<?php echo $row ['contrasena']; ?>" name="contrasena" id="password" placeholder="Contraseña" required/>
                    </div>
                    ...
                    <?php } ?>
                    <input type="submit" name="add_usuario" class="button button-block" value="Guardar Datos">
                </form>
                <a href="consul_admin"><input type="button" value="Cancelar"></a>
            </div>
        </div>
