...
<head>
  ...
  <title>Carga Demeritos | Administrador</title>
...
<header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="inicioAdmin" class="logo">Carga <span class="lite">Demeritos</span></a>
      <!--logo end-->
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                ...
                <form action="insertar_funcion_DEM" method="post">
                    ...
                    <div class="contenedor-input">
                        ...
                        <?php $fcha = date("Y-m-d");?>
                        <input type="datetime" class="form-control" name="fecha"  value="<?php echo $fcha;?>" required disabled >
                    </div>
