<?php
	...
	*/
	...
	$aColumnas = array( 'id_demerito', 'mes', 'fecha', 'No_carroceria', 'modelo', 'segmento', 'no_conformidad', 'componente', 'complemento' );
	
	/* columna indexada */
	$sIndexColumn = "id_demerito";
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?id=".$aRow['id_demerito']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?id=".$aRow['id_demerito']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
